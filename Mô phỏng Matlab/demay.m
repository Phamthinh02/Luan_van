...
ii = 0;
period = length(pmin);
fileID_1 = fopen('F:\HK211\Luan_van\data\data_P_xylanh1.json','w');
...
%xylanh2
fileID_2 = fopen('F:\HK211\Luan_van\data\data_P_xylanh2.json','w');
...
%xylanh3
fileID_3 = fopen('F:\HK211\Luan_van\data\data_P_xylanh3.json','w');
...
%xylanh4
fileID_4 = fopen('F:\HK211\Luan_van\data\data_P_xylanh4.json','w');
...
dlmwrite('F:\HK211\Luan_van\data\data.dat', data_pmin);
